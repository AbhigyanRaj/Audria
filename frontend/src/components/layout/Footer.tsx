...
export default function Footer() {
  return (
    <footer className="relative border-t border-zinc-800 bg-black mt-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1">
            ...
            <p className="text-sm text-zinc-500 leading-relaxed">
              AI-Powered Answering Machine Detection for smarter outbound calls.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/compliance" className="text-sm text-zinc-400 hover:text-white transition-colors">
                  Compliance
                </Link>
              </li>
            </ul>
        ...
        <div className="pt-8 border-t border-zinc-800">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm text-zinc-500">
              © {new Date().getFullYear()} Audria. All rights reserved.
            </p>
